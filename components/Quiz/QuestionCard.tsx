        ...
        <div className="mt-6 mb-8">
          <input
            ...
            className={`w-full bg-black border-b-2 p-4 text-xl md:text-2xl font-mono focus:outline-none transition-colors
              ${isSubmitted 
                ? (inputValue.toLowerCase().trim() === (question.correctAnswer as string).toLowerCase().trim() ? 'border-green-500 text-green-500' : 'border-red-500 text-red-500') 
          ...
          <div className="p-6 md:p-10 relative z-10">
              ...
              {!isSubmitted ? (
                  ...
                  <div ref={feedbackRef} className="overflow-hidden">
                      <div className={`p-4 border-l-4 mb-6 ${
                          (question.type === 'fillBlank' 
                            ? inputValue.toLowerCase().trim() === (question.correctAnswer as string).toLowerCase().trim() 
